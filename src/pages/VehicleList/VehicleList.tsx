...
export default function VehicleList() {
  const { categoriesData, postsData, categoryID, queryConfig } = useListQueries({ categoryName: CategoryName.vehicle })
      ...
      {pageData && categories && (
        <div className='pb-8 md:pb-10'>
          ...
          <div className='hidden lg:grid lg:grid-cols-[auto_minmax(0,1fr)] gap-8'>
            {/* Sidebar (desktop) - luôn mounted, width animate 0 <-> 352 */}
            <motion.aside
