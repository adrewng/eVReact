...
export default function FilterSidebar({ queryConfig, categories }: FilterSidebarProps) {
  ...
  return (
    <div className='sticky top-0 z-10'>
      <div className='rounded-[22px] border border-zinc-200 bg-white shadow-sm p-6 max-h-full overflow-y-auto'>
        {/* Header */}
            ...
            renderProp={categories.map((item) => {
              return (
                <FilterOptionLink
                  ...
                  param='category_type'
                  value={item.slug}
                  label={item.type === CategoryType.vehicle ? 'Vehicle' : 'Battery'} // chữ hiển thị bên trái
