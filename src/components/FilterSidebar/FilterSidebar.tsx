...
const BODY_STYLES = [
  { name: 'SUV', value: 'suv', count: 971 },
  { name: 'Sedan', value: 'sedan', count: 303 },
  { name: 'Truck', value: 'truck', count: 55 },
  { name: 'Hatchback', value: 'hatchback', count: 15 },
  { name: 'Coupe', value: 'coupe', count: 3 }
]
      ...
      <div className='sticky top-24'>
        ...
        <div className='rounded-[22px] border border-zinc-200 bg-white shadow-sm p-6'>
          ...
          <div className='space-y-6'>
            {/* Hãng */}
            <CollapseItem
              renderProp={BODY_STYLES.map((item) => {
                return (
                  <FilterOptionLink
                    key={item.value}
                    ...
                    rightBadge={item.count} // số bên phải (component sẽ tự bọc badge)
                  />
                )
              })}
            >
              <div className='text-lg font-semibold'>Hãng</div>
            </CollapseItem>
